...
static void print_employee_db(dll_t *student_db) {
...
student_t *search_student_by_rollno(dll_t *student_db,
...
employee_t *search_employee_by_emp_id(dll_t *employee_db,
